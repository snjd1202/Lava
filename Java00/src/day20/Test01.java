	...
	public Test01() {
		...
		try {
			...
			/*
			 	...
			 	이후부터는 항상 동일한 방식으로 JDBC 에게 명령을 내리면
...
//			
			...
			String sql02 = "INSERT INTO member VALUES( 1001, '최두용', 'dDragon', '12345', 'dDragon@increpas.com', 'M', '010-9292-4183', 11, 'Y')";
...
//			JOptionPane.showMessageDialog(null, "입력된 데이터 수 : " + cnt);
			...
			*/
			...
			// 현재 작업줄은 BOF이므로 실제 데이터가 들어있는 행으로 한행 내려야 된다.
			rs.next();
			/*
			int mno = rs.getInt(1);
