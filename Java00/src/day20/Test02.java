	...
	public Test02() {
		...
		try {
			...
			*/
			...
			// ? 를 채워줘야하는 질의명령을 사용할 때 사용하는 Statement는 PreparedStatement이다.
			pstmt =con.prepareStatement(psql);
			// PreparedStatement 는 질의명령을 가지고 만들어야 하고
			// 만들어진 후에는 질의명령을 완성해야 질의 명령이 정상적으로 작동할 것이다.
			...
			// 보여주고
			JOptionPane.showMessageDialog(null, name+ ((name.equals("전은석")) ?" 선생님 ": (name.equals("김수진")? " 회장님 ": " 씨 ") )+ "정보\n회원번호 : " + mno + 
												"\n회원아이디 : " + mid + "\n회원비번 : " + mpw +
												"\n회원메일 : " + mail + "\n회원성별 : " + gen + 
												"\n회원전화 : " + tel + "\n아바타번호 : " + ano + 
